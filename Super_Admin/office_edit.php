...
<body id="element">
    ...
    <div class="home-content">
      <div class="sales-boxes">
        <div class="top-sales box">
          <div class="row">
          <div class="col-md-6 col-12 title mb-5">UPDATE OFFICE STAFF DATA</div>
  ...
  if(isset($_POST['u_update_office_staff']))
  {
    ...
    $zip = $_POST['zip'];
        ...
        {
          $sql1 = "UPDATE office_data SET u_name = '$name', u_dob = '$dob', u_qualification = '$qualification' WHERE u_email = '$get_email'";
            $conn->query($sql1);
            ob_end_clean();
            header("Location:add_office.php");
            echo '<div class="alert alert-success mt-3" role="alert">OFFCIE STAFF RECORD UPDATED SUCCESSFULLY</div>';
        }
        else 
        {
  ...
  ?>
        ...
        $i=1;
        $get_email = $_GET['u_email'];
$sql = "SELECT * FROM users INNER JOIN office_data ON users.u_email = office_data.u_email WHERE users.u_email='$get_email' AND users.u_role='OFFICE STAFF'";
