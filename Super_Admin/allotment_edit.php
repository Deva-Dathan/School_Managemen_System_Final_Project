...
<body id="element">
  ...
  <div class="sidebar" id="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links" id="nav-links">
        ...
        <li>
          <a href="add_allotement.php" class="active">
            <i class='bx bxs-user-circle' style="color:var(--light);"></i>
            <span class="links_name" style="color:var(--light);">Allotment Cell</span>
          </a>
        </li>
        <li>
    ...
    <div class="home-content">
      <div class="sales-boxes">
        <div class="top-sales box">
          <div class="row">
          <div class="col-md-12 col-12 title mb-5">UPDATE ALLOTMENT CELL STAFF DATA</div>
          </div> <!--class row close div-->


  <?php
  if(isset($_POST['u_update_office_staff']))
  {
    ...
    $zip = $_POST['zip'];
        ...
        {
          $sql1 = "UPDATE allotment_cell_data SET u_name = '$name', u_dob = '$dob', u_qualification = '$qualification' WHERE u_email = '$get_email'";
            $conn->query($sql1);
            ob_end_clean();
            header("Location:add_allotment.php");
            echo '<div class="alert alert-success mt-3" role="alert">ALLOTMENT CELL STAFF RECORD UPDATED SUCCESSFULLY</div>';
        }
        else 
        {
  ...
  <?php
  if(isset($_POST['update_office_profile']))
  {
    $get_email = $_GET['u_email'];
  ...
  ?>
        ...
        $i=1;
        $get_email = $_GET['u_email'];
$sql = "SELECT * FROM users INNER JOIN allotment_cell_data ON users.u_email = allotment_cell_data.u_email WHERE users.u_email='$get_email' AND users.u_role='ALLOTMENT CELL'";
...
<div class="row  float-right">
  <div class="col-md-6"><input type="submit" name="u_update_office_staff" class="btn btn-outline-primary" value="Update Data"></div>
  <div class="col-md-6"><input type="submit" name="update_office_profile" class="btn btn-dark float-right" value="Update Profile Pic"><div>
</div>
</div>
