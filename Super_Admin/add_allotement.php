      ...
      <ul class="nav-links" id="nav-links">
        ...
        <li>
          <a href="add_office.php" class="active">
            ...
            <span class="links_name" style="color:var(--light);">Office Staff</span>
          </a>
        </li>
        <li>
    ...
    <div class="home-content">
      <div class="sales-boxes">
        <div class="top-sales box">
          <div class="row">
          <div class="col-md-6 col-12 title">OFFICE STAFF</div>
          <div class="col-md-6 col-12" style="display:flex; justify-content:right; align-items:right;"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i class='bx bx-plus'></i>&nbspNew Office Staff</button></div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">ADD NEW OFFICE STAFF</h5>
      ...
      if($_SERVER["REQUEST_METHOD"] == "POST")
      {
        ...
        if ($result->num_rows > 0) {
            ...
            $sql = "INSERT INTO users (id, u_name, u_gender, u_email, u_pass, u_role, u_address, u_mobile, u_city, u_district, u_state, u_zip, u_image) VALUES ('$uid', '$fullname', '$gender', '$email', '$password', 'OFFICE STAFF', '$address', '$mobile', '$city', '$district', '$state', '$zip', '$image')";
        
            if ($conn->query($sql) === TRUE) {
                $sql1 = "INSERT INTO office_data(u_name, u_email, u_dob, u_qualification) VALUES ('$fullname', '$email', '$dob', '$qualification')";
                $conn->query($sql1);
                echo '<script>Swal.fire({title: "NEW OFFICE STAFF APPOINTED",text: "Inserted Successfully",icon: "success"});</script>';
            } else {
    ...
    <div class="form-check">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="u_add_principal" class="btn btn-primary">Add Office Staff</button>
        </form>
      </div>
    </div>
  </div>
...
<table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
        ...
        <?php
        $i=1;
$sql = "SELECT * FROM users INNER JOIN office_data ON users.u_email = office_data.u_email";
...
<tr align=center>
              ...
              <td><a href="office_edit.php?u_email=<?php echo $row['u_email'];?>" class="btn btn-primary"><i class="bx bxs-edit"></i></a></td>
              <td><a href="office_delete.php?u_email=<?php echo $row['u_email'];?>"><button class="btn btn-danger"><i class="bx bxs-trash"></i></button></a></td>
            </tr>
<?php
  }
} 
