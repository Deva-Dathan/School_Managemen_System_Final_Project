  ...
  <div class="sidebar" id="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links" id="nav-links">
        ...
        <li>
          <a href="change_vice_principal.php" class="active">
            <i class='bx bx-user-circle' style="color:var(--light);"></i>
            <span class="links_name" style="color:var(--light);">Vice Principal</span>
          </a>
        </li>
        <li>
    ...
    <div class="home-content">
      <div class="sales-boxes">
        <div class="top-sales box">
          <div class="row">
          <div class="col-md-6 col-12 title">VICE PRINCIPAL</div>
...
?>
            ...
            <tr align=center>
              ...
              if($row['u_role'] == 'TEACHER')
              {
                $count_role = "SELECT COUNT(u_role) AS vice_principal_count FROM users WHERE u_role='VICE PRINCIPAL'";
                $count_result = mysqli_query($conn, $count_role);
