...
<body id="element">
  ...
  <div class="sidebar" id="sidebar">
    ...
    <ul class="nav-links" id="nav-links">
        ...
        <li>
          <a href="internal_marks.php" class="active">
          <i class='bx bxs-bookmarks' style="color:var(--light);"></i>
            <span class="links_name" style="color:var(--light);">Internal Marks</span>
          </a>
        </li>
      </ul>
  </div>
    ...
    <div class="home-content">
      <div class="sales-boxes">
        <div class="top-sales box">
          <div class="row">
          <div class="col-md-6 col-12 title">UPLOAD INTERNAL MARKS</div>
...
<form method="POST" action="insert_internal_marks.php" class="needs-validation" novalidate>
    ...
    studentData.forEach(function(student, index) {
      var inputs = `<hr>
        <div class="row">
          ...
          <div class="col-md-3 mb-3">
            <label for="marks${index}" class="required">Internal Marks</label>
            <input type="number" class="form-control" id="marks${index}" name="marks[]" required min="0" max="20">
            </div>
        </div>
      `;
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" id="editForm">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="editMark1">Internal Mark</label>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="saveChangesBtn">Update Internal Mark</button>
            </div>
            </form>
        </div>
    </div>
