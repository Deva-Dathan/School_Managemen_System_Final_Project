...
<body id="element">
  ...
  <div class="sidebar" id="sidebar">
    ...
    <ul class="nav-links" id="nav-links">
        ...
        <li>
          <a href="view_classes.php" class="active">
            <i class='bx bxs-user' style="color:var(--light);"></i>
            <span class="links_name" style="color:var(--light);">Allotted Classes</span>
          </a>
        </li>
        <li>
    ...
    <div class="home-content">
      <div class="sales-boxes">
        <div class="top-sales box">
          <div class="row">
          <div class="col-md-6 col-12 title">ALLOTTED CLASSES</div>
...
$sql = "SELECT * FROM subject_teacher WHERE u_email='$logged_user'";
