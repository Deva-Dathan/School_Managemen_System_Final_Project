...
<body id="element">
  ...
  <div class="sidebar" id="sidebar">
    ...
    <ul class="nav-links" id="nav-links">
        ...
        <li>
          <a href="predict_marks.php" class="active">
          <i class='bx bxs-award' style="color:var(--light);"></i>
            <span class="links_name" style="color:var(--light);">Predict Marks</span>
          </a>
        </li>
        <li>
    ...
    <div class="home-content">
      <div class="sales-boxes">
        <div class="top-sales box">
          <div class="row">
          <div class="col-md-6 col-12 title">SCORE PREDICTION</div>
...
<script>
    ...
    // Function to fetch marks data based on standard and subject
    function fetchMarksData() {
        var standard = $('#validationCustom01').val();
        var subject = $('#validationCustom04').val();
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#marksTable').show(); // Show the table after fetching data
            },
    ...
    $('#validationCustom01').change(function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#validationCustom04').append(response);
                
                // Hide the table when standard changes
                $('#marksTable').hide();
            }
        });
    });
    ...
    $('#validationCustom04').change(function () {
        // Fetch marks data when subject selection changes
        fetchMarksData();
    });
});
