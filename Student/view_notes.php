    ...
    <div class="home-content">
      <div class="sales-boxes">
        <div class="top-sales box">
          <div class="row">
          <div class="col-md-6 col-12 title">SUBJECT NOTES</div>
...
$sql = "SELECT * FROM subject_notes WHERE standard = '$std'";
...
{
  echo '<br><div class="alert alert-danger text-center font-weight-bold" role="alert">NO NOTES FOUND FOR '.$row_std['standard'].' STANDARD....!</div>';
}
?>
        </tbody>
    </table> 
