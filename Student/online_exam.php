  ...
  <div class="sidebar" id="sidebar">
    ...
    <ul class="nav-links" id="nav-links">
        ...
        <li>
          ...
          <i class='bx bxs-pencil' style="color:var(--light);"></i>
    ...
    <div class="home-content">
      <div class="sales-boxes">
        <div class="top-sales box">
          <div class="row">
          <div class="col-md-6 col-12 title">ATTEND ONLINE EXAM</div>
...
<table id="example" class="table table-striped table-bordered nowrap mt-5" style="width:100%">
        ...
        $class_sql = "SELECT standard FROM student_data WHERE u_email = '$login_email'";
        $class_result = $conn->query($class_sql);
        $class_row = $class_result->fetch_assoc();
        $class = $class_row['standard'];



$sql = "SELECT DISTINCT(online_exam_id), standard, subject, date, exam_duration, due_date FROM exam_questions WHERE standard = '$class'";
...
?>
            ...
            <td><?php echo $i++;?></td>
              ...
              <td><?php echo date('d-m-Y H:m:i', strtotime($row['due_date'])); ?></td>
              <td><a href="attend_online_exam.php?subject=<?php echo $row['subject'];?>&exam_id=<?php echo $row['online_exam_id'];?>"><button class="btn btn-outline-primary">Attend</button></a></td>
            </tr>
<?php
  }
} 
