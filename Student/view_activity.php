...
<body id="element">
  ...
  <div class="sidebar" id="sidebar">
    ...
    <ul class="nav-links" id="nav-links">
        ...
        <li>
          <a href="view_activity.php" class="active">
...
<table id="example" class="table table-striped table-bordered nowrap mt-5" style="width:100%">
      ...
      ?>
        ...
        $sql_std = "SELECT standard FROM student_data WHERE u_email = '$login_email'";
        $result_std = mysqli_query($conn, $sql_std);
        $row_std = mysqli_fetch_assoc($result_std);
        $std = $row_std['standard'];

$sql = "SELECT * FROM activity_data INNER JOIN users ON activity_data.u_email=users.u_email WHERE standard = '$std'";
...
{
  echo '<br><div class="alert alert-danger text-center font-weight-bold" role="alert">NO ACTIVITY FOUND....!</div>';
}
?>
        </tbody>
    </table> 
