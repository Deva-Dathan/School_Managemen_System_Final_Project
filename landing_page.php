...
document.addEventListener('DOMContentLoaded', startTypingAnimation);
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="category-card" style="--color: 170, 75%, 41%">
                ...
                <div class="card-icon">
                  <img src="./assets/landing_images/category-1.svg" width="40" height="40" loading="lazy"
            ...
            <li>
              <div class="category-card" style="--color: 351, 83%, 61%">
                ...
                <div class="card-icon">
                  <img src="./assets/landing_images/category-2.svg" width="40" height="40" loading="lazy"
            ...
            <li>
              <div class="category-card" style="--color: 229, 75%, 58%">
                ...
                <div class="card-icon">
                  <img src="./assets/landing_images/category-3.svg" width="40" height="40" loading="lazy"
            ...
            <li>
              <div class="category-card" style="--color: 42, 94%, 55%">
                ...
                <div class="card-icon">
                  <img src="./assets/landing_images/category-4.svg" width="40" height="40" loading="lazy"
        ...
        <div class="container">
          ...
          <figure class="about-banner">
            ...
            <div class="img-holder" style="--width: 520; --height: 370;">
              <img src="./assets/landing_images/about-banner.jpg" width="520" height="370" loading="lazy" alt="about banner"
                class="img-cover">
            </div>

            <img src="./assets/landing_images/about-shape-1.svg" width="360" height="420" loading="lazy" alt=""
              class="shape about-shape-1">

            <img src="./assets/landing_images/about-shape-2.svg" width="371" height="220" loading="lazy" alt=""
              class="shape about-shape-2">

            <img src="./assets/landing_images/about-shape-3.png" width="722" height="528" loading="lazy" alt=""
          ...
          <div class="about-content">
            ...
            <img src="./assets/landing_images/about-shape-4.svg" width="100" height="100" loading="lazy" alt=""
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="course-card">
                ...
                <figure class="card-banner img-holder" style="--width: 370; --height: 220;">
                  <img src="./assets/landing_images/course-1.jpg" width="370" height="220" loading="lazy"
            ...
            <li>
              <div class="course-card">
                ...
                <figure class="card-banner img-holder" style="--width: 370; --height: 220;">
                  <img src="./assets/landing_images/course-2.jpg" width="370" height="220" loading="lazy"
            ...
            <li>
              <div class="course-card">
                ...
                <figure class="card-banner img-holder" style="--width: 370; --height: 220;">
                  <img src="./assets/landing_images/course-3.jpg" width="370" height="220" loading="lazy"
      ...
      <section class="video has-bg-image" aria-label="video"
        style="background-image: url('./assets/landing_images/video-bg.png')">
        <div class="container">

          <div class="video-card">

            <div class="video-banner img-holder has-after" style="--width: ; --height: ;">
              <img src="./assets/landing_images/video-banner.jpg" width="970" height="550" loading="lazy" alt="video banner"
                class="img-cover">
            ...
            <img src="./assets/landing_images/video-shape-1.png" width="1089" height="605" loading="lazy" alt=""
              class="shape video-shape-1">

            <img src="./assets/landing_images/video-shape-2.png" width="158" height="174" loading="lazy" alt=""
      ...
      <section class="section blog has-bg-image" id="blog" aria-label="blog"
        style="background-image: url('./assets/landing_images/blog-bg.svg')">
        <div class="container">
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner img-holder has-after" style="--width: 370; --height: 370;">
                  <img src="./assets/landing_images/blog-1.jpg" width="370" height="370" loading="lazy"
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner img-holder has-after" style="--width: 370; --height: 370;">
                  <img src="./assets/landing_images/blog-2.jpg" width="370" height="370" loading="lazy"
                    alt="Become A Better Blogger: Content Planning" class="img-cover">
                </figure>
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner img-holder has-after" style="--width: 370; --height: 370;">
                  <img src="./assets/landing_images/blog-3.jpg" width="370" height="370" loading="lazy"
                    alt="Become A Better Blogger: Content Planning" class="img-cover">
                </figure>
          ...
          <img src="./assets/landing_images/blog-shape.png" width="186" height="186" loading="lazy" alt=""
  ...
  <footer class="footer" style="background-image: url('./assets/landing_images/footer-bg.png')">
    ...
    <div class="footer-top section">
      <div class="container grid-list">
        ...
        <div class="footer-brand">
          ...
          <a href="#" class="logo">
            <img src="./assets/landing_images/logo-light.svg" width="162" height="50" alt="EduWeb logo">
          </a>
