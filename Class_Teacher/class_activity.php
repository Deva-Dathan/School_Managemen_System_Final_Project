    ...
    <div class="home-content">
      <div class="sales-boxes">
        <div class="top-sales box">
          <div class="row">
          <div class="col-md-6 col-12 title">CLASS ACTIVITY</div>
      ...
      if($_SERVER["REQUEST_METHOD"] == "POST")
      {
        ...
        $sel_sql = "SELECT activity_no FROM activity_data WHERE standard = '$standard' AND subject = '$subject'";
        ...
        if ($result->num_rows > 0) {
            ...
            $sql = "INSERT INTO activity_data(standard, u_email, subject, activity_no, activity_topic) VALUES ('$standard', '$teacheremail', '$subject', '$activity', '$activity_topic')";
            if ($conn->query($sql) === TRUE) {
                echo '<div class="alert alert-success mt-3" role="alert">CLASS ACTIVITY ASSIGNED</div>';
            } else {
...
<div class="col-md-3 mb-3">
    <label for="validationCustom04" class="required">Activity</label>
    <select class="custom-select" name="activity" id="validationCustom04" required>
          <option selected disabled>Choose....</option>
          <option value="Activity I">Activity I</option>
          <option value="Activity II">Activity II</option>
          <option value="Activity III">Activity III</option>
    </select>
</div>
...
<div class="row">
<div class="col-md-12">
<label for="exampleFormControlTextarea1">Activity Topic</label>
<textarea class="form-control" name="activity_topic" id="exampleFormControlTextarea1" rows="3" required></textarea>
</div>
</div><!-- row close -->
