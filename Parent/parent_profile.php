...
<body id="element">
  ...
  <div class="sidebar" id="sidebar">
    ...
    <ul class="nav-links" id="nav-links">
        ...
        <li>
          <a href="online_exam_mark.php">
          <i class='bx bxs-pencil'></i>
            <span class="links_name">Online Exam Mark</span>
          </a>
        </li>
        <li>
          <a href="internal_mark.php">
          <i class='bx bx-copy-alt'></i>
            <span class="links_name">Internal Mark</span>
          </a>
        </li>
        <li>
          <a href="live_meeting.php">
...
?>
      ...
      ?>
				...
				<ul class="profile-link">
					<li><a href="parent_profile.php"><i class='bx bxs-user-circle icon' ></i> Profile</a></li>
					<li><a href="parent_settings.php"><i class='bx bxs-cog' ></i> Settings</a></li>
    ...
    <div class="home-content">
      <div class="sales-boxes">
        <div class="top-sales box">
          ...
          <?php
$get_email = $_SESSION['u_email'];
$sql = "SELECT * FROM parent_data INNER JOIN student_data ON parent_data.u_email = student_data.u_email WHERE parent_data.parent_email='$get_email'";
$result = mysqli_query($conn, $sql);
if (mysqli_num_rows($result) > 0) 
{
  while($row = mysqli_fetch_assoc($result)) 
...
<div class="row">
  <div class="col-md-4 mb-3">
    ...
    <div class="form-group">
      <label for="validationCustom01" class="required">Parent Name</label>
      <input type="text" value="<?php echo $row['parent_name'];?>" class="form-control" name="fname" id="validationCustom01" readonly>
  ...
  <div class="form-group">
      <label for="validationCustom04" class="required">Student's Name</label>
      <input type="text" value="<?php echo $row['u_name'];?>" class="form-control" name="qualification" id="validationCustom04" readonly>
      <div class="invalid-feedback">Please provide a valid qualification.</div>
    </div> <!-- form-group close -->

    <div class="form-group">
      <label for="validationCustom06" class="required">Student's Date-of-Birth</label>
  ...
  <div class="form-group">
      <label for="validationCustom04" class="required">Student's Class</label>
    ...
    <div class="form-group">
      ...
      <input type="email" value="<?php echo $row['parent_email'];?>" class="form-control" name="e-mail" id="validationCustom07" readonly>
...
<div class="col-md-6 mb-3">
<label for="validationCustom11" class="required">District</label>
<input type="text" value="<?php echo $row['u_district'];?>" class="form-control" name="state" id="validationCustom11" value="Kerala" readonly>
